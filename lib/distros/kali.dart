...
class _KaliState extends State<Kali> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> kali(Uri url) async {
      if (!await launchUrl(
        url,
    ...
    final Uri kaliwebsite = Uri(scheme: 'https', host: 'www.kali.org');
    return SafeArea(
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            orientation == Orientation.portrait
                ? Image.asset(
              'assets/distros/kali/kalilogo.png',
              height: 200.0,
              width:width,
            )
                : Image.asset(
            ...
            RichText(
                text: TextSpan(children: [
                  ...
                  const TextSpan(
                    text: '\tis a Debian-derived Linux distribution designed '
